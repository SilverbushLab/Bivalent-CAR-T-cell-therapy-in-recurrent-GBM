...
```{r}
srt_merge <- read_rds("~/processed_data/tumors_normalized_merged_scaled_annotated_coarse_srt_revision.rds")
```
...
malig_file <- "~/resources/malignant_cell_calls_tumor_revision.txt"
...
srt_merge_sub$sample_name %>% table()
...
GEX_matrix <- process_seurat_annotations(
  ...
  sample_name = "tumors_revision", # this is different from the sample name input into run infercnv. This changes the suffix of the annotation files
  output_dir = out_dir)
```
...
# set up resources
annotations_file <- "~/resources/annotations_sample_vs_control_inferCNV_figure_tumors_revision.tsv"
out_dir_base <- "~/results/inferCNV/"
gof <- "~/external_resources/hg38_gencode_v27.txt"


sample_name <- "tumors_merge_by_sample_figure_revision"
...
```{r}
#cluster by seurat cluster

# set up resources
annotations_file <- "~/resources/annotations_seurat_inferCNV_figure_tumors_revision.tsv"
out_dir_base <- "~/results/inferCNV/"
gof <- "~/external_resources/hg38_gencode_v27.txt"


sample_name <- "tumors_merge_by_cluster_figure_revision"
